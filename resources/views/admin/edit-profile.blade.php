...
<div class="container">
    ...
    <nav aria-label="breadcrumb" class="main-breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-user"><a href="index.html">Home</a></li>
            <li class="breadcrumb-user"><a href="javascript:void(0)">User</a></li>
            <li class="breadcrumb-user active" aria-current="page">Profile Settings</li>
        </ol>
    </nav>
    <!-- /Breadcrumb -->
                ...
                <div class="card-body">
                    <nav class="nav flex-column nav-pills nav-gap-y-1">
                        <a href="#profile" data-toggle="tab"
                            class="nav-user nav-link has-icon nav-link-faded active">
                        ...
                        <a href="#account" data-toggle="tab" class="nav-user nav-link has-icon nav-link-faded">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <a href="#security" data-toggle="tab" class="nav-user nav-link has-icon nav-link-faded">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <a href="#notification" data-toggle="tab" class="nav-user nav-link has-icon nav-link-faded">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <a href="#billing" data-toggle="tab" class="nav-user nav-link has-icon nav-link-faded">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body tab-content">
                    <div class="tab-pane active" id="profile">
                        ...
                        <form action="{{ route('saveChange',auth()->user()->id) }}" method="post">
                            @csrf
                                ...
                                <hr>
                            <ul class="card-body">
                                    {{-- @if (auth()->user()->website_link != null ||
                                         auth()->user()->facebook != null ||
                                         auth()->user()->facebook_link != null ||
                                         auth()->user()->instagram != null ||
                                         auth()->user()->instagram_link != null ||
                                         auth()->user()->github != null ||
                                         auth()->user()->github_link != null ||
                                         auth()->user()->twitter != null ||
                                         auth()->user()->twitter_link != null
                                        ) --}}
                                        
                                        <li
                                            class="list-group-user d-flex justify-content-between align-users-center flex-wrap">
                                            ...
                                            <input type="text" name="website_link"
                                                class="form-control mb-3" placeholder="Link Website"
                                                value="{{ auth()->user()->website_link }}">
                                        </li>
                                        <li
                                            class="list-group-user d-flex justify-content-between align-users-center flex-wrap">
                    ...
                    {{-- @php
                       $check = DB::table('social_media')->where("user_id","=",auth()->user()->id)->get();
                    @endphp --}}
                                {{-- @if(auth()->user()->website_link == null &&
                                    auth()->user()->facebook == null &&
                                    auth()->user()->facebook_link == null &&
                                    ...
                                    <div id="form-create">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <form action="{{ route('save',auth()->user()->id) }}" method="post">
                                                @csrf
                                                <ul class="list-group list-group-flush">
                                                    <li
                                                        ...
                                                        <input type="text" name="website_link_create"
                                                            class="form-control mb-3" placeholder="Link Website">
                                                    </li>
                                                    <li
                                                        class="list-group-user d-flex justify-content-between align-users-center flex-wrap">
                                                        ...
                                                        <input type="text" name="github_link"
                                                            class="form-control mb-2" placeholder="Link Profile">
                                                        <input type="text" name="github_name"
                                                            class="form-control mb-3" placeholder="Full Name">
                                                    </li>
                                                    <li
                                                        class="list-group-user d-flex justify-content-between align-users-center flex-wrap">
                                                    ...
                                                    <li
                                                        ...
                                                        <input type="text" name="instagram_link"
                                                            class="form-control mb-2" placeholder="Profile link">
                                                        <input type="text" name="instagram_name"
                                                            class="form-control mb-3" placeholder="Full Name">
                                                    </li>
                                                        <li
                                                            class="list-group-user d-flex justify-content-between align-users-center flex-wrap">
                        ...
                        <form>
                            <div class="form-group mb-0">
                                ...
                                <ul class="list-group list-group-sm">
                                    <li class="list-group-user has-icon">
                                        <div>
...
@section('script')
    ...
    <script defer>
        const check = document.getElementById("for-check");
        // if(check.className == "for-check"){
