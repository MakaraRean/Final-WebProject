...
<div class="content" style="z-index: 1">
    <div class="container">
        ...
        <br><br>
        @php
            // selete follower user_id 
            $followTo = DB::table('followers')->where('follow_to','=',$user->id)->get();
        ...
        <div class="row">
            @foreach ($followTo as $follower)
                @php
                    // select all data of follower data
                    $followers = DB::table('users')->where('id','=',$follower->user_id)->get();
                @endphp
